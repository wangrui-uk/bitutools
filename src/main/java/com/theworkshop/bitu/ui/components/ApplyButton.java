...
public class ApplyButton extends BaseComponent {

    public interface Handler {

        void onClick(ApplyButton source);
    ...
    public ApplyButton(String text, Color color) {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                if (null != handler) {
                    handler.onClick(ApplyButton.this);
                }
            }
    ...
    public void paintComponent(Graphics g) {
        ...
        g2D.fillRect(0, 0, 20, this.size.height);
